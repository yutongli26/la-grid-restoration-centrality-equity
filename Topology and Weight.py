...
class Paths:
    # Input paths
    DEVICES_CSV: str = r"C:/2025-2026 Fall/Network science/Project/LA_Substations_WithFragility_UPDATED_CEC.csv"
    LA_TRACTS_SHP: str = r"C:/2025 Spring/CE295/Supplemental Data/LA_Tracts_With_Population.shp"
    TRANSMISSION_LINES_SHP: str = r"C:/2025 Spring/CE295/Transmission_Line_7304850911266214096/TransmissionLine_CEC.shp"
    CITY_TRACTS_LIST_CSV: str = r"C:\2025-2026 Fall\Network science\Project\Tracts_Within_Los_Angeles.csv"

    # Output paths
    OUTPUT_MAPPING_CSV: str = r"C:/2025 Spring/CE295/Data/tract_to_substation_mapping_CEC.csv"
    OUTPUT_GRAPH_EDGES_CSV: str = r"C:/2025 Spring/CE295/Data/substation_graph_CEC_edges.csv"
    OUTPUT_GRAPH_NODES_CSV: str = r"C:/2025 Spring/CE295/Data/substation_graph_CEC_nodes.csv"
    OUTPUT_PLOT_PNG: str = r"C:/2025 Spring/CE295/Data/topology_final_validation.png"

    # Local zoom plot
    OUTPUT_PLOT_PNG_WEST_ZOOM: str = r"C:/2025 Spring/CE295/Data/topology_west_zoom.png"
    ...
    LAMBDA_KM: float = 40.0

    # Zoom radius (km) centered at the westernmost substation
    WEST_ZOOM_RADIUS_KM: float = 20.0

    TOP_K_SUBSTATIONS: int = 10
...
def load_substations(devices_csv: str) -> gpd.GeoDataFrame:
    ...
    Performs ID and lat/lon column normalization (preserving original behavior).
    """
...
# ---------------------------------------------------------------------------
# 3) Topology Logic (Enhanced: Attributes Preserved + MultiGraph)
# ---------------------------------------------------------------------------
...
def calculate_connectivity(
    ...
    Returns:
        ...
        all_paths: dict[src_sid] = paths dict (node -> list[node])
    """
    logger = logging.getLogger()
...
def build_W_matrix(
    ...
    Notes:
      - lambda_km and top_k_sub are retained only to preserve the original function signature.
        They are not used in the current logic.
    """
    if tracts_gdf.empty:
        return pd.DataFrame()
